...
function generateCorrectAgtConformityV11() {
    ...
    // 3. Documento Fiscal (Factura/Recibo - FR) com o mecanismo de pagamento (paymentMechanism: "NU")
    const documentPayload = {
        ...
        customerCountry: "AO",
        paymentMechanism: "NU", // "NU" = Numerário (Pronto Pagamento exigido em Factura/Recibo - FR)
        items: [
            {
                lineId: 1,
    ...
    console.log("Envelope oficial V11 (FR com paymentMechanism NU) gerado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV11();
