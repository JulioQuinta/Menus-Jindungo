...
function generateCorrectAgtConformityV3() {
    ...
    // 3. Documento Fiscal (Factura/Recibo - FR) com os nomes de campos corrigidos
    const documentPayload = {
        documentType: "FR",
        documentNo: "FR 2026/1", // Corrigido de documentNumber
        documentStatus: "N", // Novo campo obrigatório (Normal)
        documentDate: "2026-07-17", // Corrigido de dateEmitted (Formato YYYY-MM-DD)
        systemEntryDate: "2026-07-17T15:00:00Z", // Novo campo obrigatório
        issuerNif: "5417289301",
        softwareName: "Menusjindungo",
        softwareVersion: "3",
        customerName: "Consumidor Final",
        customerTaxID: "999999999", // Corrigido de customerNif
        customerAddress: "Luanda, Angola",
        customerCountry: "AO", // Novo campo obrigatório
        items: [
            {
                lineId: 1,
    ...
    // 4. Construção do Envelope Oficial da AGT com as correções estruturais do documento
    const agtEnvelope = {
        schemaVersion: "1.0",
        submissionUUID: crypto.randomUUID(), // UUID da submissão
        taxRegistrationNumber: "5417289301", // NIF do Emissor
        submissionTimeStamp: new Date().toISOString(), // Timestamp
        numberOfEntries: 1, // Campo Obrigatório
        softwareInfo: {
            softwareInfoDetail: softwareInfoDetail, // Campo softwareInfoDetail
            jwsSoftwareSignature: jwsSoftwareSignature // Assinatura JWS do software
        },
        documents: [ // Array de documentos
            {
                ...documentPayload,
                jwsDocumentSignature: jwsDocumentSignature // Assinatura JWS do documento fiscal (Corrigido de signature)
            }
        ]
    };
    ...
    console.log("Envelope oficial V3 corrigido e gravado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV3();
