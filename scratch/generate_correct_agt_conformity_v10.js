...
function generateCorrectAgtConformityV10() {
    ...
    // 3. Documento Fiscal (Factura - FT) completo (itens e totais)
    const documentPayload = {
        documentType: "FT", // Tipo Factura
    ...
    // Nova Assinatura do Documento recalculada para FT
    ...
    console.log("Envelope oficial V10 (FT) gerado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV10();
