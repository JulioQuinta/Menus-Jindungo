...
function generateCorrectAgtConformityV9() {
    ...
    // 3. Documento Fiscal (Factura/Recibo - FR) com paymentReceipt explicitamente como null
    const documentPayload = {
        ...
        paymentReceipt: null // Definido explicitamente como null para evitar o bug de undefined !== null no validador da AGT
    };
    ...
    console.log("Envelope oficial V9 gerado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV9();
