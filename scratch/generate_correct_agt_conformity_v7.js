...
function generateCorrectAgtConformityV7() {
    ...
    // 3. Documento Fiscal (Factura/Recibo - FR) sem os metadados do software e do emitente redundantes
    ...
    console.log("Envelope oficial V7 gerado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV7();
