...
function generateCorrectAgtConformityV14() {
    ...
    // 4. Linha do produto limpa e corrigida (sem taxBase nem taxAmount redundantes)
    const lines = [
        {
            lineNumber: "1",
            productCode: "P001",
            ...
            taxes: [
                {
                    ...
                    taxCode: "NOR",
                    taxPercentage: "14",
                    taxContribution: "1260.00" // Mantido como o único campo de montante de imposto da linha
                }
            ],
    ...
    console.log("Envelope oficial V14 (Removido taxBase e taxAmount redundantes) gerado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV14();
