                            ...
                            {orders.map(order => (
                                <div key={order.id} className="p-4 space-y-4">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <span className={`px-2.5 py-1 text-[8px] font-black rounded-lg border uppercase tracking-widest flex items-center gap-1.5 ${order.order_type === 'delivery'
                                            ? 'bg-purple-900/20 text-purple-400 border-purple-500/20'
                                            : 'bg-green-900/20 text-green-400 border-green-500/20'
                                            }`}>
                                            {order.order_type === 'delivery' ? 'Entrega' : 'Balcão'}
                                        </span>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-end gap-2">
                                        ...
                                        <div className="text-right shrink-0">
                                            <div className="text-lg font-bold text-[#D4AF37] leading-none">
                                                {order.total?.toLocaleString('pt-AO')} <span className="text-[10px]">Kz</span>
                                            </div>
