...
function generateCorrectAgtConformityV4() {
    ...
    const documentPayload = {
        ...
        companyName: "UMBA AQUI - COMÉRCIO E SERVIÇOS, (Lda)", // Novo campo obrigatório
    ...
    const agtEnvelope = {
        ...
        taxRegistrationNumber: "5417289301",
    ...
    console.log("Envelope oficial V4 corrigido e gravado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV4();
