...
function generateCorrectAgtConformityV13() {
    ...
    // 3. Payload de Assinatura do Documento (especificação oficial AGT DS-120)
    ...
    // 4. Linhas do Documento com os campos creditAmount, taxContribution, taxBase e taxAmount preenchidos
    const lines = [
        {
            lineNumber: "1",
            productCode: "P001",
            ...
            creditAmount: "9000.00", // Preenche o valor sem imposto da linha (Crédito para Vendas/FR)
            taxes: [
                {
                    taxType: "IVA",
                    taxCountryRegion: "AO",
                    ...
                    taxBase: "9000.00",
                    taxAmount: "1260.00",
                    taxContribution: "1260.00" // Exigido explicitamente pela regra do validador
                }
            ],
    ...
    console.log("Envelope oficial V13 (Linhas e Impostos Corrigidos) gerado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV13();
