...
function generateCorrectAgtConformityV5() {
    ...
    // 3. Documento Fiscal (Factura/Recibo - FR) com os novos dados fornecidos pelo utilizador
    const documentPayload = {
        ...
        issuerNif: "5002569450", // NIF Atualizado
        companyName: "SUMBA AQUI - COMÉRCIO E SERVIÇOS,(SU) Lda", // Nome Atualizado
    ...
    // Nova Assinatura do Documento recalculada com os dados atualizados de NIF e Nome
    const jwsDocumentSignature = generateJWS(jwsHeader, documentPayload);

    // 4. Construção do Envelope Oficial da AGT com o NIF do emissor também atualizado na raiz
    const agtEnvelope = {
        schemaVersion: "1.0",
        submissionUUID: crypto.randomUUID(),
        taxRegistrationNumber: "5002569450", // NIF do Emissor Atualizado na Raiz
        ...
        documents: [
            {
                ...documentPayload,
                jwsDocumentSignature: jwsDocumentSignature // Assinatura válida recalculada
            }
        ]
    };
    ...
    console.log("Envelope oficial V5 gerado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV5();
