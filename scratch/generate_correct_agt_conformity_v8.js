...
function generateCorrectAgtConformityV8() {
    ...
    // 3. Documento Fiscal (Factura/Recibo - FR) apenas com os campos que o validador indicou como obrigatórios
    ...
    console.log("Envelope oficial V8 gerado com sucesso!");
    console.log(JSON.stringify(agtEnvelope, null, 2));
}

generateCorrectAgtConformityV8();
